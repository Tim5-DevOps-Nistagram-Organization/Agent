...
docker-compose -f docker-compose.test.yml  --env-file ./config/.env.test -e SONAR_TOKEN_PRODUCT=${tokenProduct} SONAR_TOKEN_ORDER=${tokenOrder} SONAR_TOKEN_REPORT=${tokenReport} up -d 
