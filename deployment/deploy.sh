...
APP_IMAGE_NAME_GATEWAY=${DOCKERHUB_USERNAME}/'gateway':${VERSION}
...
DOCKER_BUILDKIT=1 docker create \
  ...
  --env APP_NAME_OREDER="${APP_NAME_AGENT_OREDER}" \
  --env APP_NAME_REPORT="${APP_NAME_AGENT_REPORT}" \
  --env APP_NAME_GATEWAY="${APP_NAME_AGENT_GATEWAY}" \
